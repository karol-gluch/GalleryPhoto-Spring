...
<body>
    ...
    <div class="main">
        <form action="${contextPath}/addImage/${id}" enctype="multipart/form-data" method="post">
            ...
            <button type="submit" class="btn btn-dark">Dodaj zdjecie</button>
        </form>
        </br>

        <form action="${contextPath}/addGallery/${id}" method="post">
            <input type="text" class="form-control mb-2 mr-sm-2" placeholder="Podaj tytuł" id="tytul" name="tytul" required>
            <textarea class="form-control mb-2 mr-sm-2" cols="40" rows="5" placeholder="Podaj opis" id="opis" name="opis" required></textarea>
            ...
            <button type="submit" class="btn btn-dark">Dodaj do galerii</button>
        </form>
